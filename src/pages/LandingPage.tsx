      ...
      <div className="max-w-3xl w-full text-center space-y-16">
        <header className="space-y-6">
          <div className="overflow-visible">
            <motion.h2
              className="text-5xl sm:text-7xl font-bold text-text-main leading-[1.3] tracking-tighter text-center"
            >
              <div className="flex flex-col items-center justify-center">
                <div className="h-[1.5em] relative w-full flex items-center justify-center overflow-hidden">
                  <AnimatePresence mode="wait">
                    <motion.div
                      ...
                      className={`flex items-center justify-center gap-6 ${currentItem.color} font-display`}
                    >
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-accent-primary rounded-full flex items-center justify-center shadow-lg shadow-accent-primary/20 rotate-12 group-hover:rotate-0 transition-transform">
                        <currentItem.icon className="text-white w-6 h-6 sm:w-8 sm:h-8" strokeWidth={2.5} />
                      </div>
                ...
                <motion.span
                  ...
                  className="block text-2xl sm:text-4xl text-transparent bg-clip-text bg-gradient-to-r from-text-main via-text-muted to-text-main font-black uppercase tracking-[0.2em] mt-4"
                >
                  Your Collection.
                </motion.span>
              </div>
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-text-muted max-w-lg mx-auto leading-relaxed font-light text-center"
          >
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-3 gap-12 pt-20 border-t border-border-subtle"
        >
          {[
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-bg-card flex items-center justify-center mx-auto group-hover:bg-accent-primary/10 transition-colors">
                <item.icon className="w-6 h-6 text-accent-primary" />
              </div>
              <h3 className="font-black text-text-main text-sm uppercase tracking-[0.2em]">{item.label}</h3>
